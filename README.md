...
Everything the [roadmap](ROADMAP.md) planned is written, with **ten runnable,
self-verifying labs** (exit `0` = the lesson held), **six break-fix support notes**, and
