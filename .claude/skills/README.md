...
| --- | --- | --- |
| [`platform-ramp`](platform-ramp/SKILL.md) | Ramp onto any platform fast + honestly: seven-surface map → skill map → AI-ramp method → ⚒️/🧭 ledger | "help me ramp onto X", "map X onto what I know", "I've never touched X" |
| [`honesty-audit`](honesty-audit/SKILL.md) | Classify every technical claim ⚒️ hands-on / 🧭 verified ramp / ❌ overclaim, with honest reframes | "is this honest", "audit my resume for overclaims", "am I bluffing" |
| [`author-module`](author-module/SKILL.md) | Write a new module (platform / cross-cutting / companion / **support note** / lab) matching the repo's voice, structure, ⚒️/🧭 markers, research grounding, and validated mermaid | "add a note on X", "write a support note for X", "keep it consistent with the repo" |
