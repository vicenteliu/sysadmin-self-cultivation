/* The sidebar: the retrieval index, sliced four ways.
   ...
   The nav lists canonical (English) documents only — the 31 Chinese mirrors are not
   ...
   is tagged `EN`, because 31 of 204 canonical documents have a mirror — a fact a
...
/** Canonical documents only, in a stable order: a folder's README, then everything else.
    ...
    why. It is the same hiding the nav already does for the 31 mirrors, applied to a
