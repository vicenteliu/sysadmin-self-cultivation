...
summary: "纯本地、可拆的练习。那些云需要一个账号，而这个平台需要的是一台开了嵌套虚拟化的笔记本 —— 不需要数据中心就能练裸金属纪律的诚实方式。"
---
# 自托管 / 裸金属 —— Lab
...
纯本地、可拆的练习。那些云需要一个账号，而这个平台需要的是一台开了嵌套虚拟化的笔记本 ——
不需要数据中心就能练裸金属纪律的诚实方式。
