...
- **变更** —— 一次带审批、带窗口、带执行、带事后复盘的计划修改。它是套在一次
  [CI/CD](../../../cross-cutting/ci-cd.md) 部署或一次 [IaC](../../../cross-cutting/iac-and-config.md) apply 外面的那层人类流程包装 ——
...
- **没有记录的变更** —— 那个没人开工单的"快速修复"，是流程层的[漂移](../../../cross-cutting/iac-and-config.md)：现在
