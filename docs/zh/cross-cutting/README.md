...
| 笔记 | 覆盖什么 | 状态 |
| --- | --- | --- |
| [`identity-iam.md`](../../../cross-cutting/identity-iam.md) | 最小权限、role 与 policy 之别、短期凭据、生命周期（JML）、SSO/SAML/OIDC、SCIM —— 在 AD、Entra、AWS IAM、Azure RBAC、GCP IAM、Okta 上是同一门纪律。 | ✅ |
...
| [`itsm-and-assets.md`](../../../cross-cutting/itsm-and-assets.md) | ITSM（事件/请求/变更）、CMDB、资产对账、访问治理与审计。**🔨** | ✅ |
| [`saas-admin.md`](../../../cross-cutting/saas-admin.md) | Google Workspace 与 M365 管理、身份主干、SCIM 生命周期 —— 把生产力套件当作一份受管估算面。 | ✅ |
...
| [`cost.md`](../../../cross-cutting/cost.md) | 把成本当作一等的运维控制：预算、告警、right-sizing、"被遗忘的 GPU 实例"问题。 | ✅ |
