...
> 🌐 **语言：** [English（默认）](../../../toolbox/README.md) · **中文**
>
> ⚠️ 本项目**默认语言为英文**，`toolbox/README.md` 是"事实来源"。本页中文是多语言支持的一部分，可能略滞后于英文版；两者不一致时以英文为准。
...
上面的脚本负责*发现*；[`ansible/`](ansible/) roles 负责*修复*，且幂等：
...
前六个工具看的是 OS *内部*；这四个看它底下的平台——合在一起回答这一季的
