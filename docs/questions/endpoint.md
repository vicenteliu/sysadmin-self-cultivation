...
| 4 | What is the blast radius of a policy before you run it on three thousand machines? | ✅ | [`labs/policy-blast-radius/`](../../endpoint/labs/policy-blast-radius/) — and the answer is that it is not a number, it is a function of time. The console's count is stable and cannot tell you it has expired |
