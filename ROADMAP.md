...
| Retrieval | front-matter on 375 files as the single source + [`docs/build-index.py`](docs/build-index.py) → [`docs/index.json`](docs/index.json) (403 records, mirrors derived). Agent-facing; idempotent, `--check` reports staleness | ✅ |
