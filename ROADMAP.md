...
| Walkthrough | [`walkthrough/`](walkthrough/README.md) — a second route, spoken rather than read: the format, the five decisions ([ADR-0009](docs/adr/0009-the-walkthrough-ships-its-script-not-its-audio.md)–[0013](docs/adr/0013-godot-is-a-design-tool-and-the-floor-keeps-one-palette.md)) and the viewer registration are written, and **episode 01 is built** — 106 beats in two languages over an interactive 2D floor. Scripts ship, audio never does. Grows one episode at a time like `toolbox/`, with no target count | ✅ |
