...
| Retrieval | front-matter on 379 files as the single source + [`docs/build-index.py`](docs/build-index.py) → [`docs/index.json`](docs/index.json) (407 records, mirrors derived). Agent-facing; idempotent, `--check` reports staleness | ✅ |
