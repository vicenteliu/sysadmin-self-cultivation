...
| Retrieval | front-matter on 381 files as the single source + [`docs/build-index.py`](docs/build-index.py) → [`docs/index.json`](docs/index.json) (409 records, mirrors derived). Agent-facing; idempotent, `--check` reports staleness | ✅ |
