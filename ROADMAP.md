...
| Figures | 4 branded hero diagrams (axis map · the stack · the ramp · the route), authored once and derived into 12 artifacts by [`site/build-diagrams.py`](site/build-diagrams.py), plus the 67 in-document mermaid diagrams. Medium decided by [ADR-0007](docs/adr/0007-a-figures-medium-is-decided-by-what-renders-it.md) | ✅ |
