...
| Retrieval | front-matter on 367 files as the single source + [`docs/build-index.py`](docs/build-index.py) → [`docs/index.json`](docs/index.json) (395 records, mirrors derived). Agent-facing; idempotent, `--check` reports staleness | ✅ |
