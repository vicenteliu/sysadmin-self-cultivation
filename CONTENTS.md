...
| [`build-out/GAPS.md`](build-out/GAPS.md) | Six real gaps the scenario surfaced, four of them the same shape — **one now closed** by [`remote-access-four-causes`](cross-cutting/labs/remote-access-four-causes/) | ✅ living |
